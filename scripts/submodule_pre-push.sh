...
# To use this script, create a symbolic link from .git/hooks/pre-push to cmake/aicxx/hooks/pre-push:
#
# $ cd .git/hooks && ln -s ../../cmake/aicxx/hooks/pre-push
#
# To create the alias, run
#
# $ git config --local alias.upsh '!'"$(realpath cmake/aicxx/scripts/upsm-push.sh)"
